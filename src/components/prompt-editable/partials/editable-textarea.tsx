...
import { Input, Editable, EditablePreview, EditableTextarea as RootEditableTextarea } from '@chakra-ui/react';
...
export const EditableTextarea = ({ content, executeMethod }: EditableTextareaProps) => {
	...
	return (
		<Editable textAlign="center" defaultValue={content} fontSize="2xl" isPreviewFocusable={false}>
			<EditablePreview maxW="700px" maxH="300px" noOfLines={5} overflowY="hidden" fontSize=".98rem" textAlign="start" />
			<Input as={RootEditableTextarea} resize="vertical" minH="300px" minW="700px" textAlign="start" value={value} onChange={(e) => setValue(e.target.value)} />
